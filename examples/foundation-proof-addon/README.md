...
The addon suggests `[[proof-note]]` in source view and `#proof` in both source and rich editors. Rich wiki-link insertion remains unavailable until Hibi can certify a lossless source mapping. Selecting `#proof` offers an undoable **Capitalize proof tag** action. Hovering the tag shows a short explanation.
